...
sudo cp  /usr/syno/etc/certificate/_archive/Urop5B/privkey.pem /volume1/docker/linanw/platox-ai-james/docker-deploy/root/conf/
sudo cp  /usr/syno/etc/certificate/_archive/Urop5B/cert.pem /volume1/docker/linanw/platox-ai-james/docker-deploy/root/conf/
